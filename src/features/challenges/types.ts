...
export type Challenge = { id: string; title: string; prompt: string; status: string; attempts: number; created_at: string; individual?: boolean; own_solved?: boolean; solved_count?: number; failed_attempts?: number; penalty_points?: number; assistance_hint?: string | null };
