  ...
  return (
    <div className="space-y-8">
      ...
      <div className="feature-grid">
        <section className="feature-card"><BookOpen className="text-[#426348]" size={27} strokeWidth={1.5} /><span className="coming-soon">Coming soon</span><h2>Your syllabus</h2><p>A shared picture of what you’re learning, one topic at a time.</p><div className="placeholder-note">Your group’s topics will live here.</div></section>
