...
insert into public.syllabus_topics (room_id, title, status, last_taught_by)
values ((select value::uuid from campfire_test_ids where name = 'room_a'), 'Cells', 'verified', auth.uid());
